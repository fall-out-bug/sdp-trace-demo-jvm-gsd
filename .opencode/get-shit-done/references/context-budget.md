...
The keys live in `.claude/settings.json` (project) or `/Users/fall_out_bug/projects/vibe_coding/sdp-trace-demo-jvm-gsd/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
