...
<required_reading>
@/Users/fall_out_bug/projects/vibe_coding/sdp-trace-demo-jvm-gsd/.opencode/get-shit-done/references/ai-frameworks.md
@/Users/fall_out_bug/projects/vibe_coding/sdp-trace-demo-jvm-gsd/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/fall_out_bug/projects/vibe_coding/sdp-trace-demo-jvm-gsd/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/fall_out_bug/projects/vibe_coding/sdp-trace-demo-jvm-gsd/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/fall_out_bug/projects/vibe_coding/sdp-trace-demo-jvm-gsd/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/fall_out_bug/projects/vibe_coding/sdp-trace-demo-jvm-gsd/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/fall_out_bug/projects/vibe_coding/sdp-trace-demo-jvm-gsd/.opencode/agents/gsd-eval-planner.md for instructions.
